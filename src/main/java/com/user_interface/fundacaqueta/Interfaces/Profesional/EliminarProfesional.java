 ...
 * @author nebel
 */
public class EliminarProfesional extends javax.swing.JFrame {
    
    private InterfazAdmin parentAdmin;
    /**
     * Creates new form EliminarProfesional
     */
    public EliminarProfesional(InterfazAdmin parent) {
        initComponents();
        this.parentAdmin = parent;
        this.txtNombre.setText(parentAdmin.obtenerProfesionalSeleccionado().obtenerNombre());
        this.txtDocumento.setText(String.valueOf(parentAdmin.obtenerProfesionalSeleccionado().obtenerDocumento()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Profesional");

        jLabel2.setText("Esto eliminará también sus contratos y actividades.");
        ...
        jLabel5.setText("¿Está seguro que desea eliminar el siguiente profesional?");
    ...
    private void bttnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnConfirmarActionPerformed
        // TODO add your handling code here:
        parentAdmin.eliminarProfesional(parentAdmin.ELIMINAR_PROFESIONAL);
